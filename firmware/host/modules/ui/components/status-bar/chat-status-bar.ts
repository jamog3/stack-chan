...
import {
  ...
  type EnvironmentFooterContract,
  type EnvironmentReader,
} from './environment-footer.js'

export type { EnvironmentReader, EnvironmentSample } from './environment-footer.js'
...
class ChatStatusBarBehavior extends Behavior {
  ...
  updateUI() {
    ...
    const environmentBehavior = this.#footer?.behavior as EnvironmentFooterContract | undefined
...
export const ChatStatusBar = Container.template((options: ChatStatusBarOptions = {}) => {
  ...
  return {
    ...
    contents: [
      ...
      createEnvironmentFooter({ reader: options.readEnvironment }),
    ],
